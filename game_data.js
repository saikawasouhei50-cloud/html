// --- 게임 설정 ---
            ...
            const dungeons = [
    {
        name: '초보자의 숲',
        stages: [
            { name: '1-1', monsterName: '슬라임 킹', reward: { pens: 5 } },
            { name: '1-2', monsterName: '슬라임 킹', reward: { pens: 5 } },
            { name: '1-3', monsterName: '슬라임 킹', reward: { pens: 6 } },
            { name: '1-4', monsterName: '슬라임 킹', reward: { pens: 6 } },
            { name: '1-5', monsterName: '오크 대장', reward: { pens: 8, currency: 10 } }, // 중간 보스 보상
            { name: '1-6', monsterName: '슬라임 킹', reward: { pens: 7 } },
            { name: '1-7', monsterName: '슬라임 킹', reward: { pens: 7 } },
            { name: '1-8', monsterName: '오크 대장', reward: { pens: 9 } },
            { name: '1-9', monsterName: '오크 대장', reward: { pens: 9 } },
            { name: '1-10', monsterName: '오크 대장', reward: { pens: 15, currency: 30 } }, // 최종 보스 보상
        ]
    },
			...
			const enhancementCosts = [10, 20, 35, 55, 80, 110, 150, 200, 250]; // +1 ~ +9 강화 비용
